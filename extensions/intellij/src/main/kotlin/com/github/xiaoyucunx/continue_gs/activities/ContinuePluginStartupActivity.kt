package com.github.xiaoyucunx.continue_gs.activities
...
import com.github.xiaoyucunx.continue_gs.listeners.ContinuePluginSelectionListener
import com.github.xiaoyucunx.continue_gs.services.ContinueExtensionSettings
import com.github.xiaoyucunx.continue_gs.services.ContinuePluginService
import com.github.xiaoyucunx.continue_gs.services.SettingsListener
...
class ContinuePluginStartupActivity : StartupActivity, Disposable, DumbAware {
    ...
    private fun initializePlugin(project: Project) {
        ...
        coroutineScope.launch {
            ...
            GlobalScope.async(Dispatchers.IO) {
                val myPluginId = "com.github.xiaoyucunx.continue_gs"
